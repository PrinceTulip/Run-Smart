...
function bindSlider(slidesSelector, prevSelector, nextSelector, dotsSelector, activeDotSelector) {
  ...
  var activeDot = activeDotSelector;
  var slideIndx = 1;
  var pause = null;
...
var close = popup.querySelector(".popup-form__close");
var link = document.querySelectorAll(".popup-button");
...
function forms() {
  ...
  form.forEach(function (item) {
    ...
    item.addEventListener('submit', function (e) {
      ...
      requestData("urlvlad", formdata).then(function (res) {
        item.reset();
        closeAllPopup();
...
},{"regenerator-runtime":1,"wow.js":2}]},{},[3]);
